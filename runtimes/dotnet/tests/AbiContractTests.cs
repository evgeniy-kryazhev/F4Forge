...
public sealed unsafe class AbiContractTests
{
    ...
    public void NativeStructuresHaveExpectedLayout()
    {
        ...
        Assert.Equal(24, sizeof(NativeHostBinding));
        Assert.Equal(72, sizeof(ManagedBootstrapArgs));
        ...
        Assert.Equal(64, Marshal.OffsetOf<ManagedBootstrapArgs>(nameof(ManagedBootstrapArgs.Runtime)).ToInt32());
