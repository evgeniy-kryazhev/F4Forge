...
static_assert(sizeof(F4ForgeRuntimeInitializeParams) == 72);
...
static_assert(offsetof(F4ForgeRuntimeInitializeParams, runtime) == 32);
static_assert(offsetof(F4ForgeRuntimeInitializeParams, pluginDirectory) == 40);
static_assert(offsetof(F4ForgeRuntimeInitializeParams, configDirectory) == 56);
...
static_assert(offsetof(F4ForgeManagedBootstrapArgs, pluginDirectory) == 32);
static_assert(offsetof(F4ForgeManagedBootstrapArgs, configDirectory) == 48);
static_assert(offsetof(F4ForgeManagedBootstrapArgs, runtime) == 64);
static_assert(sizeof(F4ForgeManagedBootstrapArgs) == 72);
