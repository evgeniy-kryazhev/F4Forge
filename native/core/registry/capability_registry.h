...
public:
    ...
    F4ForgeResult Register(F4ForgeStringView id, uint32_t version, EndpointOwner* owner) noexcept;
    void InvalidateOwner(EndpointOwner* owner) noexcept;
    uint32_t Query(F4ForgeStringView id, uint32_t minimumVersion) const noexcept;
